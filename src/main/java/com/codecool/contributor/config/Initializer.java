...
public class Initializer {
    ...
    public void init() {
        ...
        projectStorage.add(new Project("ProjectCook", "Cook some stuff!", "cooky", "cCompany", "Igen", tags));
        projectStorage.add(new Project("ProjectBoi", "Boiboiboi!", "CsakBo", "Boicompany", "Igeb", tags));
        tags2.add("taglalat");
        projectStorage.add(new Project("ProjectTagTest", "tagtest!", "Nem", "TestCompy", "reqi", tags2));
