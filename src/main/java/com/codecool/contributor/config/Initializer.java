    ...
    public CommandLineRunner init() {
        ...
        return args -> {
            ...
            Project pharmap = Project.builder()
                    ...
                    .desc("A simple map application with the nearest pharmacys")
            ...
            Project doggo = Project.builder()
                    ...
                    .desc("Web application for an animal shelter for an easier adoption process. We'd like a list of the animals with a datapage for each of them. And also we'd like a Map on our page for the soon to be adopters to find us easily")
                    .organisation("Doggo")
            ...
            Project suitup = Project.builder()
                    ...
                    .desc("A simple mobile app (for Android and iOS too) that lists all the clothes collecting places with the type of clothes they need (adult, little girl or boy clothes etc.) The app would show the place's contacts, addresses and shows them on a map as well. It also sends you notification about the upcomming clothes collecting events.")
            ...
            Project childrenshope = Project.builder()
                    ...
                    .desc("A simple donation page for a children's home. You can send donations, check previous donating people and you can also read about the organisation's history and work")
